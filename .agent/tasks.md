...
- [x] Add local AI model catalog with recommended, planned, and compatibility-check states.
- [x] Add onboarding guidance that local AI models are optional downloads instead of bundled app assets.
