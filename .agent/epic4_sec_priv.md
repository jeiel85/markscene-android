...
- [x] **[Sec] 모델 다운로드 토큰 암호화 스토리지**: Android Keystore 기반 EncryptedSharedPreferences + allowBackup=false + auto-backup 방지. (2026-05-29)
...
- [x] **[Sec] 클립보드 보호**: 모델 다운로드 토큰 입력 필드 마스킹 + 자동완성 차단 + 표시/숨김 토글. (2026-05-29)
