...
### Fixed
- **의존성 해결**: `kotlinx-coroutines-play-services` 누락으로 인한 ML Kit 비동기 처리 오류를 수정했습니다.
- **최종 안정화**: 모든 UI 화면의 임포트 및 실험적 API 설정을 정비하여 빌드 안정성을 확보했습니다.
...
### Build / CI
- 앱 버전을 `v1.8.2` (versionCode 182)으로 업데이트했습니다.
