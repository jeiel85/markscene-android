...
### Fixed
- **컴파일 오류 수정**: v1.8.0 배포 시 발생했던 `RecordDao` 구문 오류 및 누락된 임포트들을 모두 해결했습니다.
- **비주얼 Q&A 안정화**: 채팅 엔진의 비동기 처리 및 데이터베이스 연동 로직의 안정성을 강화했습니다.
...
### Build / CI
- 앱 버전을 `v1.8.1` (versionCode 181)으로 업데이트했습니다.
