...
- It does not require an external AI API key to run the core app or local advanced analysis.
...
- Do not hardcode sample API keys or model-download tokens.
...
10. Add optional local VLM provider.
